...
FOUNDATION_EXPORT void MRMediaRemoteGetNowPlayingClient(dispatch_queue_t queue, MRMediaRemoteGetNowPlayingClientBlock block);
FOUNDATION_EXPORT CFStringRef MRNowPlayingClientGetBundleIdentifier(id clientObj);
