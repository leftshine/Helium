...
extension UIApplication {
    ...
    func inputAlert(title: String, body: String, confirmTitle: String = okString, placeholder: String = placeholderString, text: String = "", keyboardType: UIKeyboardType = .default, onOK: @escaping (String) -> Void, noCancel: Bool) {
        DispatchQueue.main.async {
            currentUIAlertController = UIAlertController(title: title, message: body, preferredStyle: .alert)
    ...
    func optionsAlert(title: String, body: String, options: [String], preferredStyle: UIAlertController.Style = .actionSheet, onSelection: @escaping (String) -> Void) {
        DispatchQueue.main.async {
    ...
    func confirmAlert(title: String = errorString, body: String, confirmTitle: String = okString, onOK: @escaping () -> Void, noCancel: Bool) {
        DispatchQueue.main.async {
            currentUIAlertController = UIAlertController(title: title, message: body, preferredStyle: .alert)
            if !noCancel {
                currentUIAlertController?.addAction(.init(title: cancelString, style: .cancel))
